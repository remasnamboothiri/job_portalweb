# Generated by Django 5.2.3 on 2025-08-22 08:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('active', 'Active'), ('paused', 'Paused'), ('closed', 'Closed'), ('expired', 'Expired'), ('filled', 'Position Filled')], default='active', max_length=20)),
                ('enable_ai_interview', models.BooleanField(default=False)),
                ('interview_duration', models.CharField(blank=True, choices=[('15', '15 minutes'), ('30', '30 minutes'), ('45', '45 minutes'), ('60', '60 minutes')], default='30', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('active', 'Active'), ('paused', 'Paused'), ('closed', 'Closed'), ('expired', 'Expired'), ('filled', 'Position Filled')], default='Pending', max_length=20)),
