...
def generate_tts(text, voice_id="female_default", force_gtts=False):
    ...
    TTS_BASE_URL = "https://93tj0uaqynjms9-8000.proxy.runpod.net"
...
def check_tts_system():
    ...
    health_info = {
        ...
        'tts_api_url': "https://93tj0uaqynjms9-8000.proxy.runpod.net",
    }
    ...
    try:
        response = requests.get("https://93tj0uaqynjms9-8000.proxy.runpod.net", timeout=10)
        ...
        try:
            ...
            synth_response = requests.post(
                "https://93tj0uaqynjms9-8000.proxy.runpod.net/synthesize",
                json=test_payload,
                timeout=10,
